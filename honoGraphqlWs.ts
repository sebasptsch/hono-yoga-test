...
import { handleProtocols, makeServer, type ServerOptions } from 'graphql-ws';
...
export function makeGraphQLWsMiddleware<
    /** The Websocket Type */
    T extends WeakKey = WeakKey,
    HE extends Env = any, HP extends string = any, I extends Input = {},
    P extends ConnectionInitMessage['payload'] = ConnectionInitMessage['payload'],
    E extends Record<PropertyKey, unknown> = Record<PropertyKey, never>,

>(options: ServerOptions<P, Extra<T, HE, HP, I> & Partial<E>> & MakeHonoHooksOptions<T>) {
    const isProd =
